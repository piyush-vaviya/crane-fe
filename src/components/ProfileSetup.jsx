    ...
    >
        ...
        <CraneTooltip
          ...
          content={
            <div className="flex-center cursor-pointer">
              <CgClose
                size={18}
                className="profile-show-hide p-1"
                onClick={hideProfileEditor}
              />
            </div>
          }
        />
      ...
      <div className="profile-workSpace">
        <div className="profile-image flex-center flex-column  m-auto position-relative ">
          {src ? <img src={src} alt="" /> : <HiUser size={"32vh"} />}
          {workSpaceOwner}
        </div>
        <div className="profile-edit d-flex flex-column px-3 py-3">
          <div className="d-flex justify-content-between align-items-center">
            <div className="m-0 fs-5 fw-bold">{username}</div>
        ...
        <div className="show-status px-3 pY-1">
          <div className="d-flex align-items-center">
            ...
            <div className="ml-2">{active ? "Active" : "Away"}</div>
          </div>

          <div className="local-time d-flex flex-column py-2 ">
            <div className="d-flex align-items-center fs-6-7 fw-normal">
              <HiOutlineClock className="pr-1" /> {getFullTime("hh:mm tt")}{" "}
              Local time
            </div>
          </div>

          <div className="d-flex align-items-center justify-content-between mt-2">
            <div className="status-update-setting  flex-center set-status cursor-pointer fs-6-7 ">
              {setStatus}
            </div>
